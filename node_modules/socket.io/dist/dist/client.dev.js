...
function () {
  ...
  _createClass(Client, [{
    ...
    value: function doConnect(name, auth) {
      ...
      nsp._add(this, auth, function (socket) {
    ...
    value: function writeToEngine(encodedPackets, opts) {
      ...
      try {
        for (var _iterator2 = packets[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
