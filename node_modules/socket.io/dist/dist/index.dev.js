  ...
  _createClass(Server, [{
    ...
    value: function of(name, fn) {
      ...
      if (!nsp) {
        ...
        try {
          for (var _iterator2 = this.parentNamespacesFromRegExp[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      return regeneratorRuntime.async(function close$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return regeneratorRuntime.awrap(Promise.allSettled(_toConsumableArray(this._nsps.values()).map(function _callee(nsp) {
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.next = 3;
                        return regeneratorRuntime.awrap(nsp.adapter.close());
            ...
            case 2:
              this.engine.close(); // restore the Adapter prototype, when the Socket.IO server was attached to a uWebSockets.js server
    ...
    value: function serverSideEmitWithAck(ev) {
      ...
      return (_this$sockets4 = this.sockets).serverSideEmitWithAck.apply(_this$sockets4, [ev].concat(args));
    }
    /**
