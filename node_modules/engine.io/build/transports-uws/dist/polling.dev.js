...
function (_transport_1$Transpor) {
  ...
  _createClass(Polling, [{
    ...
    value: function onRequest(req) {
      var res = req.res; // remove the reference to the ServerResponse object (as the first request of the session is kept in memory by default)
    ...
    value: function onPollRequest(req, res) {
      ...
      this.writable = true;
      this.emit("ready"); // if we're still writable but had a pending close, trigger an empty send
